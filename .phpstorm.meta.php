...
namespace PHPSTORM_META {
    ...
    */
    ...
    override(\config(), map([
            ...
            'filesystems.links.C:\Users\Ren\Desktop\Tecno Web\Laravel con Inertia\tecnoweb\public\storage' => 'string',
...
'filesystems.disks.s3.report','filesystems.links.C:\\Users\\Ren\\Desktop\\Tecno Web\\Laravel con Inertia\\tecnoweb\\public\\storage','logging.default','logging.deprecations.channel','logging.deprecations.trace',
...
'dompdf.options.enable_html5_parser','inertia.ssr.enabled','inertia.ssr.url','inertia.testing.ensure_pages_exist','inertia.testing.page_paths',
...
'web','api',);
        registerArgumentsSet('routes', 'home','login','login.post','logout',
'profile','profile.update','register','register.post','dashboard',
'gestiones.index','gestiones.create','gestiones.store','gestiones.show','gestiones.edit',
'gestiones.update','gestiones.destroy','gestiones.activar','docentes.index','docentes.create',
'docentes.store','docentes.show','docentes.edit','docentes.update','docentes.destroy',
'programas.index','programas.create','programas.store','programas.show','programas.edit',
'programas.update','programas.destroy','certificaciones.index','certificaciones.create','certificaciones.store',
'certificaciones.show','certificaciones.edit','certificaciones.update','certificaciones.destroy','certificaciones.emitir',
'tesis.index','tesis.create','tesis.store','tesis.show','tesis.edit',
'tesis.update','tesis.destroy','tesis.aprobar','users.index','users.update',
'search.index','excel.index','excel.upload','excel.procesar','excel.show',
'excel.destroy','excel.plantilla','reportes.index',
'reportes.informeAnual','reportes.resumenProgramas','reportes.estadoAlumnos','reportes.reporteDocentes','reportes.resumenDefensas',
'reportes.data','busqueda','storage.local',);
        registerArgumentsSet('views', 
'app','reportes.estado-alumnos','reportes.informe-anual','reportes.reporte-docentes','reportes.resumen-defensas',
'reportes.resumen-programas','welcome','laravel-exceptions-renderer::components.card','laravel-exceptions-renderer::components.context','laravel-exceptions-renderer::components.editor',
