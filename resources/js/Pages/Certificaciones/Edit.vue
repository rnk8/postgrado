...
const form = useForm({
  programa_id: props.certificacion.programa_id,
  nombre_est: props.certificacion.nombre_est,
  nro_registro_est: props.certificacion.nro_registro_est,
  genero_est: props.certificacion.genero_est,
  nota: props.certificacion.nota,
  nota_defensa_tfg: props.certificacion.nota_defensa_tfg,
  fecha_defensa_tfg: props.certificacion.fecha_defensa_tfg,
  fecha_emision: props.certificacion.fecha_emision,
  estado: props.certificacion.estado,
});

const submit = () => {
  form.put(route('certificaciones.update', props.certificacion.id));
};
</script>
  ...
  <AppLayout>
    ...
    <div class="card bg-base-100 shadow-xl max-w-4xl mx-auto">
      <form @submit.prevent="submit" class="card-body space-y-6">
        <h2 class="card-title">Certificación: {{ certificacion.numero }}</h2>
