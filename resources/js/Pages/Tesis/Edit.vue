...
const form = useForm({
    ...
    nombre_est: props.tesis.nombre_est,
    nro_registro_est: props.tesis.nro_registro_est,
    fecha_defensa_tfg: props.tesis.fecha_defensa_tfg,
    nota_defensa_tfg: props.tesis.nota_defensa_tfg,
    programa_id: props.tesis.programa_id,
    tutor_id: props.tesis.tutor_id,
    estado: props.tesis.estado
});

const submit = () => {
    form.put(route('tesis.update', props.tesis.id));
};
</script>
